...
class AddFullContract extends Component {
  ...
  handleChange = value => {
    this.setState({
      InstallmentPaymentMethod: value
    });
  };
  handleChange1 = value => {
    this.setState({
  ...
  updateProperty = data => {
    try {
      axios
        .post(
          "http://localhost:5000/api/installementContract/addInstallmentContract",
          data
        )
        .then(result => {
          console.log("result: ", result);
      ...
      <Form>
        ...
        <Form.Item>
          <Row>
            ...
            <Col span={19}>
              <Select
                defaultValue="Chon loại hình thanh toán"
                style={{ width: 900 }}
        ...
        <Form.Item>
          <Row>
            ...
            <Col span={19}>
              <Select
                defaultValue="Chon loại thời hạn thanh toán"
                style={{ width: 900 }}
        ...
        <Form.Item>
          <Row>
            ...
            <Col span={19}>
              <Input name="LoanAmount" onChange={this.onChange}></Input>
            </Col>
          </Row>
        </Form.Item>
        <Row>
